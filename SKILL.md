...
- **脚本逻辑**：`~/.hermes/scripts/mc_version_check.py` 查 **Paper + Folia 双核心**（parse_papermc.py 支持 `[paper|folia]` 参数，Folia 输出含本地对比）+ 21 插件各官方渠道最新版（Modrinth/Hangar/GitHub/metadata.luckperms.net/geysermc）vs 本地 `~/minecraft-server/plugins/` 部署版本（读 jar 内 plugin.yml/paper-plugin.yml）
