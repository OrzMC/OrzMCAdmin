...
- **最新稳定版**：paper-26.2-121（**2026-08-30 本地已实际运行**：8-30 cron 巡检发现本地仍 112 → 10:54 替换 start.sh 引用并重启，端口 25565 验证运行；sha 0de30efb；**Exaroton/MCSM 仍 112 待升**；26.2-92 与 111 行为可能不同，本地复现必须与线上同构建）；**Java 要求**：26.x 需要 Java 25；**Folia 26.2-7**（2026-08-29 本地 26.2-4→7 升级完成，start.sh 已引用，待下次接管测试服时启动）
