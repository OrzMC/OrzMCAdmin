...
// 示例:
//   node portal-cmd.js 25565 "/portal 192.168.0.35 25566"
//   node portal-cmd.js 25565 "/portal remove 192.168.0.35 25566"
// 注意: mineflayer 需要 version '1.21.11'（服务器装 ViaVersion 转换到 26.2）
const mineflayer = require('mineflayer');

const PORT = process.argv[2] || '25565';
const CMD = process.argv[3] || '/portal 192.168.0.35 25566';
const HOST = process.argv[4] || '192.168.0.35';
